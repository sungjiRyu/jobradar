    ...
    sections: [
      {
        ...
        body: "회원가입 시 이메일 주소, 비밀번호(암호화 저장), 닉네임을 수집합니다. 서비스 이용 과정에서 공고 조회 기록과 Google Analytics를 통한 일반화된 페이지 경로, 접속 시각, 유입 도메인 및 접속 환경 정보가 자동으로 처리될 수 있습니다. 검색어, URL 쿼리, 공고 ID 및 회원 식별정보는 분석 정보로 전송하지 않습니다.",
      },
      {
        heading: "2. 개인정보 수집 및 이용 목적",
        body: "수집된 개인정보는 회원 식별 및 로그인, 스크랩 기능 제공, 서비스 운영 및 개선을 위해 사용됩니다. 방문 통계는 페이지별 이용 추이를 확인하는 목적으로만 사용합니다.",
      },
      {
        heading: "3. 개인정보 보유 및 이용 기간",
        body: "회원 탈퇴 시 회원 개인정보는 즉시 삭제됩니다. 단, 관련 법령에 의해 보존이 필요한 경우 해당 기간 동안 보관됩니다. Google Analytics의 사용자 및 이벤트 수준 데이터 보관 기간은 2개월로 설정합니다.",
      },
      {
        heading: "4. 개인정보 제3자 제공",
        body: "서비스는 회원가입 정보를 외부에 제공하지 않습니다. 방문 통계 분석을 위해 Google LLC의 Google Analytics를 이용하며, 페이지 이용 및 접속 환경 정보가 Google의 글로벌 인프라에서 처리될 수 있습니다.",
      },
      {
        heading: "5. 서비스 이용 통계",
        body: "사용자 통계를 분석하기 위해 Google Analytics 4를 사용합니다. 이 과정에서 개인 식별정보를 제외한 페이지 방문 및 접속 환경 정보가 수집될 수 있습니다. 브라우저의 추적 방지 기능으로 수집을 차단할 수 있습니다.",
      },
      {
        heading: "6. 개인정보 보호 조치",
        body: "비밀번호는 BCrypt 알고리즘으로 암호화하여 저장되며, 서버와의 모든 통신은 HTTPS로 보호됩니다.",
      },
      {
        heading: "7. 문의",
